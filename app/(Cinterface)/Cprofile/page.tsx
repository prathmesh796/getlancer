              ...
              {Object.entries(clientProfile.socialLinks || {}).map(([platform, link]: [string, any]) => {
                ...
                return (
                  <a
                    ...
                    className="group relative overflow-hidden rounded-2xl bg-linear-to-br from-deep_blue to-marine_blue p-6 shadow-lg hover:shadow-2xl transform hover:scale-110 transition-all duration-300"
                  >
