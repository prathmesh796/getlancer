...
export async function POST(req) {
    ...
    try {
        ...
        if (profilePic && typeof profilePic === 'string' && profilePic.startsWith('data:')) {
            ...
            updateFields.profilePic = { url: profilePic };
        }
...
export async function PUT(req) {
    ...
    try {
        ...
        if (skillsJSON) {
            try {
                updateFields.skills = JSON.parse(skillsJSON);
            } catch (e) {
        ...
        if (experienceJSON) {
            try {
                updateFields.experience = JSON.parse(experienceJSON);
            } catch (e) {
        ...
        if (projectsJSON) {
            try {
                updateFields.projects = JSON.parse(projectsJSON);
            } catch (e) {
