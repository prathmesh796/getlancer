  ...
  return (
    <div className="flex flex-col items-center justify-center m-10 bg-white">
      ...
      <div className="flex space-x-10 mb-8 m-10 gap-24">
        <div
          className={`p-8 w-64 h-48 flex flex-col items-center justify-center border-2 rounded-lg cursor-pointer ${
            selectedAccount === 'client' ? 'border-black' : 'border-gray-300'
          }`}
        ...
        <div
          className={`p-8 w-64 h-48 flex flex-col items-center justify-center border-2 rounded-lg cursor-pointer ${
            selectedAccount === 'freelancer' ? 'border-black' : 'border-gray-300'
          }`}
