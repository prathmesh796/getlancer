...
export default function DeveloperMCQTest() {
  ...
  if (showResults) {
    ...
    return (
      <div className=" w-full p-4 max-w-3xl mx-auto  border-black border-2 rounded-lg">
        <div>
        ...
        <div>
          <div onClick={() => window.location.reload()} className="border-black border-2 rounded-lg">Retake Test</div>
        </div>
      </div>
    )
  }
