...
export default function ViewProfilePage({ params }: { params: Promise<{ userId: string }> }) {
    ...
    if (loading) {
        return (
            <div className="flex justify-center items-center h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
                <div className="animate-pulse text-gray-600 dark:text-slate-400 text-2xl font-semibold">Loading profile...</div>
            </div>
        );
    }
    ...
    if (error) {
        return (
            <div className="flex flex-col justify-center items-center h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
                <p className="text-red-600 text-xl mb-4">Error loading profile: {error}</p>
                <button
                    onClick={() => router.back()}
                    className="px-6 py-2 bg-gradient-to-r from-yellow to-light_yellow text-deep_blue rounded-full font-semibold hover:shadow-lg transition-all"
                >
                    Go Back
                </button>
            </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                                ...
                                <div className="p-8">
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                        {profile.projects.map((project, index) => (
                                            <div
                                                key={index}
                                                className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-gray-100 to-gray-200 dark:from-slate-700 dark:to-slate-600 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-105"
                                            >
                                                {project.image && (
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="grid grid-cols-1 gap-4">
                            <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-blue-500 to-blue-600 p-6 shadow-xl text-white">
